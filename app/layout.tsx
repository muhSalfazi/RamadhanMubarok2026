...
export const metadata: Metadata = {
  metadataBase: new URL("https://jadwal-sholat-ramadhan.vercel.app"),
  title: {
    default: "Jadwal Sholat Ramadhan 2026 | Waktu Sholat Indonesia",
    template: "%s | Jadwal Sholat Ramadhan 2026",
  },
  description:
