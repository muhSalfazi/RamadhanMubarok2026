        ...
        <div className="min-h-screen bg-neutral-950 relative selection:bg-emerald-500/30">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 pt-6 md:pt-10 pb-80">
                <header className="mb-8">
                    <Link href="/doa" className={`inline-flex items-center ${activeTab === 'pagi' ? 'text-emerald-400 hover:text-emerald-300' : 'text-amber-400 hover:text-amber-300'} transition-colors mb-4`}>
